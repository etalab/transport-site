...
Tous les jeux de données publiés actuellement (au 15/01/2021) sur le PAN sont sous ce format.
...
Le SIRI Lite est un dérivé de SIRI qui ne contient que les informations suivantes afin de le rendre plus accessible : 
