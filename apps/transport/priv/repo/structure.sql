...
CREATE TABLE public.commune (
    ...
    epci_insee character varying(255)
);
...
CREATE TABLE public.dataset (
    ...
    custom_title character varying(255) NOT NULL,
    created_at timestamp without time zone NOT NULL,
    description text,
    frequency character varying(255) NOT NULL,
    last_update timestamp without time zone NOT NULL,
    licence character varying(255) NOT NULL,
    logo character varying(255) NOT NULL,
    full_logo character varying(255) NOT NULL,
    slug character varying(255) NOT NULL,
    tags character varying(255)[] NOT NULL,
    datagouv_title character varying(255) NOT NULL,
    type character varying(255) NOT NULL,
    region_id bigint,
    aom_id bigint,
    organization character varying(255),
    has_realtime boolean DEFAULT false NOT NULL,
    is_active boolean DEFAULT true NOT NULL,
    search_vector tsvector,
    population integer,
    nb_reuses integer NOT NULL,
    ...
    search_payload jsonb DEFAULT '{}'::jsonb,
    custom_logo character varying(255),
    custom_full_logo character varying(255)
);
...
--
-- Name: dataset_monthly_metrics; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.dataset_monthly_metrics (
    id bigint NOT NULL,
    dataset_datagouv_id character varying(50) NOT NULL,
...
--
-- Name: dataset_monthly_metrics_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.dataset_monthly_metrics_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dataset_monthly_metrics_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.dataset_monthly_metrics_id_seq OWNED BY public.dataset_monthly_metrics.id;
...
CREATE TABLE public.epci (
    ...
    mode_financement character varying(255),
    geom public.geometry
);
...
--
-- Name: resource_monthly_metrics; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.resource_monthly_metrics (
    id bigint NOT NULL,
    resource_datagouv_id character varying(50) NOT NULL,
    year_month character varying(7) NOT NULL,
    metric_name character varying(50) NOT NULL,
    count integer NOT NULL,
    inserted_at timestamp without time zone NOT NULL,
...
--
-- Name: resource_monthly_metrics_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.resource_monthly_metrics_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: resource_monthly_metrics_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.resource_monthly_metrics_id_seq OWNED BY public.resource_monthly_metrics.id;
...
--
-- Name: dataset_monthly_metrics id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dataset_monthly_metrics ALTER COLUMN id SET DEFAULT nextval('public.dataset_monthly_metrics_id_seq'::regclass);
...
--
-- Name: resource_monthly_metrics id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.resource_monthly_metrics ALTER COLUMN id SET DEFAULT nextval('public.resource_monthly_metrics_id_seq'::regclass);
...
--
-- Name: dataset_monthly_metrics dataset_monthly_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dataset_monthly_metrics
    ADD CONSTRAINT dataset_monthly_metrics_pkey PRIMARY KEY (id);
...
--
-- Name: resource_monthly_metrics resource_monthly_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.resource_monthly_metrics
    ADD CONSTRAINT resource_monthly_metrics_pkey PRIMARY KEY (id);
...
--
-- Name: commune_epci_insee_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commune_epci_insee_index ON public.commune USING btree (epci_insee);
...
--
-- Name: dataset_monthly_metrics_dataset_datagouv_id_year_month_metric_n; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX dataset_monthly_metrics_dataset_datagouv_id_year_month_metric_n ON public.dataset_monthly_metrics USING btree (dataset_datagouv_id, year_month, metric_name);
...
--
-- Name: epci_insee_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX epci_insee_index ON public.epci USING btree (insee);
...
--
-- Name: resource_monthly_metrics_resource_datagouv_id_year_month_metric; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX resource_monthly_metrics_resource_datagouv_id_year_month_metric ON public.resource_monthly_metrics USING btree (resource_datagouv_id, year_month, metric_name);
...
--
-- Name: aom aom_departement_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.aom
    ADD CONSTRAINT aom_departement_fkey FOREIGN KEY (departement) REFERENCES public.departement(insee);
...
--
-- Name: commune commune_epci_insee_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commune
    ADD CONSTRAINT commune_epci_insee_fkey FOREIGN KEY (epci_insee) REFERENCES public.epci(insee) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.resource_related
    ADD CONSTRAINT resource_related_resource_dst_id_fkey FOREIGN KEY (resource_dst_id) REFERENCES public.resource(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.resource_related
    ADD CONSTRAINT resource_related_resource_src_id_fkey FOREIGN KEY (resource_src_id) REFERENCES public.resource(id) ON DELETE CASCADE;
...
INSERT INTO public."schema_migrations" (version) VALUES (20231214145408);
INSERT INTO public."schema_migrations" (version) VALUES (20231222145809);
INSERT INTO public."schema_migrations" (version) VALUES (20231231135108);
INSERT INTO public."schema_migrations" (version) VALUES (20240102144643);
INSERT INTO public."schema_migrations" (version) VALUES (20240110085755);
INSERT INTO public."schema_migrations" (version) VALUES (20240117075117);
INSERT INTO public."schema_migrations" (version) VALUES (20240123133743);
