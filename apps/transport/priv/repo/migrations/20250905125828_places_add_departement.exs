defmodule DB.Repo.Migrations.PlacesAddDepartement do
  use Ecto.Migration
  ...
  def up do
    ...
    (
        ...
        (
          SELECT
            ad.nom AS nom,
            CAST(ad.insee AS varchar) AS place_id,
            'departement' AS type,
    ...
    # Call of the trigger for region, departement, aom and commune update
    execute("""
