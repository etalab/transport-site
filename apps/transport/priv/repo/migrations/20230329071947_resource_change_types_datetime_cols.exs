defmodule DB.Repo.Migrations.ResourceChangeTypesDateTimeCols do
  ...
  def up do
    execute "ALTER TABLE resource ALTER COLUMN last_import TYPE timestamp without time zone USING last_import::timestamp;"
    execute "ALTER TABLE resource ALTER COLUMN last_update TYPE timestamp without time zone USING last_update::timestamp;"
