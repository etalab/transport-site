...
![Un bus du réseau Agglo'bus à Guéret](/blog/Agglo'bus_1_(c)_Collection_Grand_GuÇret.JPG) 
...
![La création d'un fichier GTFS a permis que l'offre de transport du Grand Guéret soit intégrée au service de calcul d'itinéraire régional Modalis](/blog/Modalis_screenshot01.jpg) 
...
![Localisation des arrêts d'une ligne de bus dans OpenStreetMap](/blog/OSM_Gueret.png)
...
![Manipulation du logiciel Static GTFS Manager](/blog/StaticGTFSManager_screenshot.jpg)
...
![Création du tracé d'une ligne de bus dans OpenStreetMaps](/blog/trace_OSM.png)
