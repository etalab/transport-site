defmodule Transport.EnRouteChouetteValidClient.Wrapper do
  ...
  @callback create_a_validation(filepath :: Path.t(), rule_set :: binary(), xsd_version :: binary()) :: binary()
...
defmodule Transport.EnRouteChouetteValidClient do
  ...
  def create_a_validation(filepath, rule_set, xsd_version) do
      ...
      http_client().post!(
        ...
        {:multipart,
         [
           ...
           {"validation[schema_version]", xsd_version},
