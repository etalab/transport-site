defmodule DB.Resource do
  ...
  def issues_short_translation,
    do: %{
      ...
      "NegativeTravelTime" =>
        dgettext("db-validations", "Negative travel time between two stops"),
      ...
      "UnloadableModel" =>
        dgettext("db-validations", "Not compliant with the GTFS specification"),
      ...
      "ImpossibleToInterpolateStopTimes" =>
        dgettext("db-validations", "Impossible to interpolate stop times")
    }
