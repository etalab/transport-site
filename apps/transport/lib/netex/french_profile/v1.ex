defmodule Transport.NeTEx.FrenchProfile.V1 do
  @moduledoc """
  Definition of the validation rules for the French NeTEx profile.

  This definition is still work in progress. It's versioned to track progress
  ...
  def slug, do: "pan:french_profile:1"
