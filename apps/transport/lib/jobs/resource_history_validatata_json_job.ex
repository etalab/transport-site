defmodule Transport.Jobs.ResourceHistoryValidataJSONJob do
  @moduledoc """
  Validate a `DB.ResourceHistory` with Transport.Validators.ValidataLot2 and stores the result in the database.
  """
  ...
  def validator, do: Transport.Validators.ValidataLot2
end
