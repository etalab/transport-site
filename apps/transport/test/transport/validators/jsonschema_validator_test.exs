defmodule Transport.Validators.JSONSchemaTest do
  use ExUnit.Case, async: false
  import DB.Factory
  import Mox
  import Transport.Validators.JSONSchema

  doctest Transport.Validators.JSONSchema, import: true
  ...
  describe "validate" do
    test "valid object" do
      assert %{
               ...
               "has_errors" => false,
               "errors" => [],
               "validator" => Transport.Validators.JSONSchema
             } ==
  ...
  test "inserts the expected data in the database" do
    ...
    assert :ok == validate_and_save(resource_history)
  ...
  test "perform_validation when validator returns nil" do
    ...
    assert %{"validation_performed" => false} == perform_validation(schema_name, schema_version, permanent_url)
  end
