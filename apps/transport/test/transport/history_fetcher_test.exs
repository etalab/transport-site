defmodule Transport.History.FetcherTest do
  ...
  describe "Fetcher.Database" do
    test "history_resources" do
      ...
      resources_history = Transport.History.Fetcher.Database.history_resources(dataset, preload_validations: true)
      ...
      assert Enum.count(Transport.History.Fetcher.Database.history_resources(dataset, max_records: 1)) == 1
