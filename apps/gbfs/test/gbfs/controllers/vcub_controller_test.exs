defmodule GBFS.VCubControllerTest do
  ...
  test "VCub GBFS conversion, test gbfs.json", %{conn: conn} do
  ...
  test "VCub GBFS conversion, test system_information.json", %{conn: conn} do
  ...
  test "VCub GBFS conversion, test station_information.json", %{conn: conn} do
  ...
  test "VCub GBFS conversion, test station_status.json", %{conn: conn} do
