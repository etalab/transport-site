defmodule GBFS.VCubController do
          ...
          |> Stream.map(
            fn d ->
              ...
              %{
                ...
                is_installed: 1,
                is_renting: if etat == "CONNECTEE" do 1 else 0 end,
                is_returning: if etat == "CONNECTEE" do 1 else 0 end,
  ...
  defp to_wgs84(%Exshape.Shp.PointZ{x: x, y: y}) do
    c = 11_754_255.426096 #constante de la projection
    e = 0.0818191910428158 #première exentricité de l'ellipsoïde@
    n = 0.725607765053267 #exposant de la projection@
    xs = 700_000 #coordonnées en projection du pole@
    ys = 12_655_612.049876 #coordonnées en projection du pole@
    ...
    %{
      ...
      lat: :math.asin(:math.tanh((:math.log(c / :math.sqrt(:math.pow((x - xs), 2) + :math.pow((y - ys), 2))) / n) + e * :math.atanh(e * (:math.tanh(a + e * :math.atanh(e * (:math.tanh(a + e * :math.atanh(e * (:math.tanh(a + e * :math.atanh(e * (:math.tanh(a + e * :math.atanh(e * (:math.tanh(a + e * :math.atanh(e * (:math.tanh(a + e * :math.atanh(e * :math.sin(1)))))))))))))))))))))) / :math.pi * 180
    }
  end
end
